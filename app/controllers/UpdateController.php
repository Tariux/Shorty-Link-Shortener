...
class Update {
    ...
    private function update(){
        ...
        DB::alter('user', function($table){
            ...
            if(DB::columnExists('user', 'phone') === false){
                $table->add()->string('phone')->index();
            }
            if(DB::columnExists('user', 'phone_verify') === false){
                $table->add()->int('phone_verify', null, '0');
            }
