...
Gem::group('/user', function(){
    ...
    Gem::get('/verify_phone', 'Users@VerifyPhone')->name('verify.phone');
    Gem::post('/verify_phone/auth', 'Users@VerifyPhoneAuth')->middleware('CheckDomain')->middleware('UserLogged')->name('verify.phone.auth');
    ...
    Gem::setMiddleware(['CheckDomain', 'Auth' , 'PhoneVerified']);
...
Gem::get('/{id}/stats/abtesting', 'Stats@abtesting')->middleware('CheckDomain')->name('stats.abtesting');
