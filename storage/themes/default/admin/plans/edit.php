        ...
        <form method="post" action="<?php echo route('admin.plans.update', [$plan->id]) ?>" enctype="multipart/form-data">
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" data-binary="true" id="permission-abtesting-enabled" name="permission[abtesting][enabled]" value="1" data-toggle="togglefield" data-toggle-for="permission-abtesting-count" <?php echo isset($plan->permission->abtesting->enabled) && $plan->permission->abtesting->enabled ? 'checked': '' ?>>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" data-binary="true" id="permission-expiration-enabled" name="permission[expiration][enabled]" value="1" data-toggle="togglefield" data-toggle-for="permission-expiration-count" <?php echo isset($plan->permission->expiration->enabled) && $plan->permission->expiration->enabled ? 'checked': '' ?>>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" data-binary="true" id="permission-clicklimit-enabled" name="permission[clicklimit][enabled]" value="1" data-toggle="togglefield" data-toggle-for="permission-clicklimit-count" <?php echo isset($plan->permission->abtesting->enabled) && $plan->permission->abtesting->enabled ? 'checked': '' ?>>
            ...
            <div class="row mb-4">                                
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" data-binary="true" id="permission-poweredby-enabled" name="permission[poweredby][enabled]" value="1" data-toggle="togglefield" data-toggle-for="permission-poweredby-count" <?php echo isset($plan->permission->poweredby->enabled) && $plan->permission->poweredby->enabled ? 'checked': '' ?>>
