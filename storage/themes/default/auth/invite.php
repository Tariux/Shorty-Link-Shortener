                    ...
                    <div class="card-body py-5 px-sm-5">
                        <div>
                            ...
                            <form method="post" action="<?php echo route('acceptinvitation', [$token]) ?>">
                                ...
                                <!--- jaryan update --->
                                <div class="form-group">
                                    <label class="form-control-label" for="user-phone"><?php ee('Phone') ?></label>
                                    <div class="input-group input-group-merge">
                                    <input type="phone" class="form-control form-control-prepend" id="user-phone" name="phone" placeholder="<?php ee('Please enter a valid phone. (0912345789)') ?>" value="<?php echo old('phone') ?>">
                                        <div class="input-group-prepend">
