                    ...
                    <?php if(isset($profiledata['social'])): ?>
                        <div id="social" class="text-center mt-3">
                            <?php foreach($profiledata['social'] as $key => $value): ?>
                                ...
                                <a href="#" class="ml-3" target="_blank" data-toggle="tooltip" data-placement="top" title="<?php echo ucfirst($key) ?>" rel="nofollow"><i class="fab fa-<?php echo $key ?>"></i></a>
                            <?php endforeach ?>
                        </div>
                    <?php endif ?>
                <?php endif ?>
                ...
                <?php foreach($profiledata['links'] as $id => $value): ?>
                    <div class="item mb-3">
                        ...
                        <?php if($value['type'] == "whatsapp"): ?>
                            <a href="#" class="btn btn-block d-block p-3 btn-custom position-relative"><img src="<?php echo assets('images/whatsapp.svg') ?>" height="26" class="ml-3 position-absolute left-0"> <?php echo isset($value['label']) && $value['label'] ? $value['label'] : $value['phone'] ?></a>
                        <?php endif ?>

                        <?php if($value['type'] == "phone"): ?>
                            <a href="#" class="btn btn-block d-block p-3 btn-custom position-relative"><i class="fa fa-phone ml-3 position-absolute left-0"></i> <?php echo isset($value['label']) && $value['label'] ? $value['label'] : $value['phone'] ?></a>
                        <?php endif ?>
                        ...
                        <?php if($value['type'] == "link"): ?>
                            <a href="#" class="<?php echo (isset($value['animation']) && in_array($value['animation'], ['shake','wobble','vibrate','jello','scale']) ? 'animate_'.$value['animation'].' ':'') ?>btn btn-block p-3 btn-custom position-relative">
                        ...
                        <?php if($value['type'] == "contact"): ?>
                            ...
                            <form method="get" action="#" id="C<?php echo $id ?>" class="collapse border rounded text-left p-3 mt-3">
                        ...
                        <?php if($value['type'] == "product"): ?>
                            <a href="#" target="_blank" class="d-flex border p-1 rounded mt-2" rel="nofollow">
                            ...
                            <?php foreach($value['question'] as $i => $question): ?>
                                <div class="card mb-1">                                    
                                    <div class="card-body text-left">
                                        <a href="#faq-<?php echo $i ?>" data-toggle="collapse" data-target="#faq-<?php echo $i ?>"><h6 class="card-title mb-0"><?php echo $question ?></h6></a>
