    ...
    <div class="collapse" id="advancedOptions">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mt-3">
                <div class="form-group">
                    <label for="channel" class="form-label"><?php echo e("Channel")?></label>
                    <p class="form-text"><?php echo e('Assign link to a channel.')?></p>
                    <div class="rounded input-select">
        ...
        <?php endif ?>
        <?php if (\Core\Auth::user()->has("expiration") !== false): ?>
            <div class="collapse mt-4" id="expiration">
                <hr>
                <div class="d-flex">
                    <h4><i class="me-2" data-feather="refresh-ccw"></i> <span class="align-middle"><?php echo e("Expiration")?></span></h4>
                </div>
                <p class="form-text">
                ...
                <div class="row" >
                    ...
                    <?php if(\Core\Auth::user()->has("clicklimit") !== false):?>
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                <label for="expiry" class="form-label"><?php ee('Click Limit') ?></label>
                                <p class="form-text"><?php ee('Limit the number of clicks.') ?></p>
                                <div class="input-group">
                                    <div class="input-group-text bg-white"><i data-feather="lock"></i></div>
                                    <input type="text" class="form-control border-start-0 ps-0" name="clicklimit" id="clicklimit" autocomplete="off" placeholder="e.g. 100">
                                </div>
                            </div>
                        </div>
                    <?php endif ?>
                ...
                <div class="form-group mt-3">
                    <label for="expiry" class="form-label"><?php ee('Expiration Redirect') ?></label>
                    <p class="form-text"><?php ee('Set a link to redirect traffic to when the short link expires.') ?></p>
                    <div class="input-group">
                        <span class="input-group-text bg-white"><i data-feather="globe"></i></span>
                        <input type="text" name="expirationredirect" class="form-control border-start-0 ps-0" placeholder="<?php echo e("Type the url to redirect user to.")?>">
                    </div>
                </div>
            </div>
        <?php endif ?>
        <?php if (\Core\Auth::user()->has("abtesting") !== false): ?>
            <div class="collapse mt-4" id="abtesting">
                <hr>
                <div class="d-flex">
                ...
                <div class="row" data-toggle="addable" data-label="abtesting">
                    <div class="col-sm-6 mt-3">
                        <div class="input-group">
                            <span class="input-group-text bg-white"><i data-feather="globe"></i></span>
                            <input type="text" name="abtesting[]" class="form-control border-start-0 ps-0" placeholder="<?php echo e("Type the url to redirect user to.")?>">
                        </div>
                    </div>
                    <div class="col-sm-6 mt-3">
                        <div class="input-group">
                            <span class="input-group-text bg-white"><i data-feather="percent"></i></span>
                            <input type="text" name="abtestingpercent[]" class="form-control border-start-0 ps-0" placeholder="<?php echo e("Type percentage e.g. 100")?>">
                        </div>
                    </div>
                </div>
            </div>
