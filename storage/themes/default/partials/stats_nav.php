<ul class="nav nav-tabs overflow-x">
    ...
    <li class="nav-item">
        <a href="<?php echo route('stats.countries', $url->id) ?>" class="nav-link"><i data-feather="map-pin"></i> <?php ee('Countries & Cities') ?></a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a href="<?php echo route('stats.abtesting', $url->id) ?>" class="nav-link"><i data-feather="refresh-cw"></i> <?php ee('A/B Testing') ?></a>
    </li>
</ul>