    ...
    <div class="col-md-9">
        <div class="card p-2">
			<div class="d-flex align-items-center">
				<div class="ms-auto">
					<form action="<?php echo route('qr') ?>" method="get" class="d-flex align-items-center">
						<div class="me-2">
							<input type="text" class="form-control border p-2" name="q" value="<?php echo clean(request()->q) ?>" placeholder="<?php ee('Search for {t}', null, ['t' => e('QR Codes')]) ?>">
						</div>
						<div class="me-2">
