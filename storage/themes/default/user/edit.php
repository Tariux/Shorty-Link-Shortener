            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php if(user()->has('expiration')): ?>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    <label for="clicklimit" class="form-label"><?php ee('Expiration by Clicks') ?></label>
                                    <div class="input-group">
                                        <div class="input-group-text bg-white"><i data-feather="lock"></i></div>
                                        <input type="text" class="form-control p-2 border-start-0 ps-0" name="clicklimit" id="clicklimit" placeholder="e.g. 100" autocomplete="off" value="<?php echo $url->clicklimit ?>">
                                    </div>
                                </div>
                                <?php endif ?>
                            </div>
                    ...
                    <?php if( \Core\Auth::user()->has("abtesting") !== false):?>
                        <hr>
                        <div class="row mt-4" id="abtesting">
                            <div class="d-flex">
                            ...
                            <?php foreach($url->rotators as $rotator):?>
                                <div class="row">
                                    <div class="col-sm-6 mt-3">
                                        <div class="input-group">
                                            <span class="input-group-text bg-white"><i data-feather="globe"></i></span>
                                            <input type="text" name="abtesting[]" class="form-control border-start-0 ps-0" placeholder="<?php echo e("Type the url to redirect user to.")?>" value="<?php echo $rotator['link'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 mt-3">
                                        <div class="input-group">
                                            <span class="input-group-text bg-white"><i data-feather="percent"></i></span>
                                            <input type="text" name="abtestingpercent[]" class="form-control border-start-0 ps-0" placeholder="<?php echo e("Type percentage e.g. 100")?>"value="<?php echo $rotator['percent'] ?>">
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach ?>
